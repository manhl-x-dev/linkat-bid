  ...
  const loadSettings = useCallback(async () => {
    try {
      ...
      if (data.success && data.settings) {
        ...
        // Map database keys to settings
        if (data.settings.siteName) loadedSettings.siteName = data.settings.siteName;
        if (data.settings.domain) loadedSettings.domain = data.settings.domain;
        if (data.settings.description) loadedSettings.description = data.settings.description;
        if (data.settings.email) loadedSettings.email = data.settings.email;
        if (data.settings.defaultLanguage) loadedSettings.defaultLanguage = data.settings.defaultLanguage;
        if (data.settings.referralCommission) loadedSettings.referralCommission = Number(data.settings.referralCommission);
        if (data.settings.minWithdrawal) loadedSettings.minWithdrawal = Number(data.settings.minWithdrawal);
        if (data.settings.cpmRate) loadedSettings.cpmRate = Number(data.settings.cpmRate);
        if (data.settings.userShare) loadedSettings.userShare = Number(data.settings.userShare);
        if (data.settings.autoWithdrawal !== undefined) loadedSettings.autoWithdrawal = data.settings.autoWithdrawal === 'true';
        if (data.settings.twoFactorAuth !== undefined) loadedSettings.twoFactorAuth = data.settings.twoFactorAuth === 'true';
        if (data.settings.spamProtection !== undefined) loadedSettings.spamProtection = data.settings.spamProtection === 'true';
        if (data.settings.contentFilter !== undefined) loadedSettings.contentFilter = data.settings.contentFilter === 'true';
        if (data.settings.emailNotifications !== undefined) loadedSettings.emailNotifications = data.settings.emailNotifications === 'true';
        if (data.settings.withdrawalAlerts !== undefined) loadedSettings.withdrawalAlerts = data.settings.withdrawalAlerts === 'true';
        if (data.settings.reportAlerts !== undefined) loadedSettings.reportAlerts = data.settings.reportAlerts === 'true';
